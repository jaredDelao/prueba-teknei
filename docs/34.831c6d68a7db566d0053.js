    ...
    qCuA: function (o, e, t) {
      ...
      const l = (o, e) => {
          ...
          const r = o.querySelector('.popover-content'),
            ...
            s = n.width,
            p = n.height,
            a = o.ownerDocument.defaultView.innerWidth,
            l = o.ownerDocument.defaultView.innerHeight,
            h = e && e.target && e.target.getBoundingClientRect(),
            v = null != h && 'top' in h ? h.top : l / 2 - p / 2,
            b = null != h && 'left' in h ? h.left : a / 2,
            m = (h && h.width) || 0,
            f = (h && h.height) || 0,
            u = o.querySelector('.popover-arrow'),
            x = u.getBoundingClientRect(),
            g = x.width,
            w = x.height;
          null == h && (u.style.display = 'none');
          const y = { top: v + f, left: b + m / 2 - g / 2 },
            k = { top: v + f + (w - 1), left: b + m / 2 - s / 2 };
          let j = !1,
            O = !1;
          k.left < d + 25
            ? ((j = !0), (k.left = d))
            : s + d + k.left + 25 > a && ((O = !0), (k.left = a - s - d), (i = 'right')),
            v + f + p > l && v - p > 0
              ? ((y.top = v - (w + 1)),
                (k.top = v - p - (w - 1)),
                (o.className = o.className + ' popover-bottom'),
                (t = 'bottom'))
              : v + f + p > l && (r.style.bottom = d + '%'),
            (u.style.top = y.top + 'px'),
            (u.style.left = y.left + 'px'),
            (r.style.top = k.top + 'px'),
            (r.style.left = k.left + 'px'),
            j && (r.style.left = `calc(${k.left}px + var(--ion-safe-area-left, 0px))`),
            O && (r.style.left = `calc(${k.left}px - var(--ion-safe-area-right, 0px))`),
            (r.style.transformOrigin = t + ' ' + i);
          const D = Object(c.a)(),
            E = Object(c.a)(),
            P = Object(c.a)();
          return (
            E.addElement(o.querySelector('ion-backdrop'))
              .fromTo('opacity', 0.01, 'var(--backdrop-opacity)')
              .beforeStyles({ 'pointer-events': 'none' })
              .afterClearStyles(['pointer-events']),
            P.addElement(o.querySelector('.popover-wrapper')).fromTo('opacity', 0.01, 1),
            D.addElement(o).easing('ease').duration(100).addAnimation([E, P])
          );
        },
        d = 5,
        h = (o) => {
          ...
          return (
            ...
            i.addElement(o.querySelector('.popover-wrapper')).fromTo('opacity', 0.99, 0),
            e.addElement(o).easing('ease').duration(500).addAnimation([t, i])
          );
        },
        v = (o, e) => {
          ...
          const s = o.querySelector('.popover-content'),
            ...
            v = e && e.target && e.target.getBoundingClientRect(),
            b = null != v && 'bottom' in v ? v.bottom : h / 2 - l / 2,
            m = (v && v.height) || 0,
            f = { top: b, left: null != v && 'left' in v ? (i ? v.left - a + v.width : v.left) : d / 2 - a / 2 };
          f.left < 12 ? ((f.left = 12), (n = 'left')) : a + 12 + f.left > d && ((f.left = d - a - 12), (n = 'right')),
            b + m + l > h && b - l > 0
              ? ((f.top = b - l - m), (o.className = o.className + ' popover-bottom'), (r = 'bottom'))
              : b + m + l > h && (s.style.bottom = '12px');
          const u = Object(c.a)(),
            x = Object(c.a)(),
            g = Object(c.a)(),
            w = Object(c.a)(),
          ...
          return (
            x
              ...
              .beforeStyles({ 'pointer-events': 'none' })
              .afterClearStyles(['pointer-events']),
            g.addElement(o.querySelector('.popover-wrapper')).fromTo('opacity', 0.01, 1),
            w
              .addElement(s)
              .beforeStyles({ top: f.top + 'px', left: f.left + 'px', 'transform-origin': `${r} ${n}` })
              .fromTo('transform', 'scale(0.001)', 'scale(1)'),
            y.addElement(o.querySelector('.popover-viewport')).fromTo('opacity', 0.01, 1),
            u.addElement(o).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(300).addAnimation([x, g, w, y])
          );
        },
        b = (o) => {
          const e = Object(c.a)(),
        ...
        m = class {
          constructor(o) {
            Object(i.o)(this, o),
              (this.didPresent = Object(i.g)(this, 'ionPopoverDidPresent', 7)),
              (this.willPresent = Object(i.g)(this, 'ionPopoverWillPresent', 7)),
              (this.willDismiss = Object(i.g)(this, 'ionPopoverWillDismiss', 7)),
              (this.didDismiss = Object(i.g)(this, 'ionPopoverDidDismiss', 7)),
              (this.presented = !1),
              ...
              (this.onLifecycle = (o) => {
                const e = this.usersElement,
                  t = f[o.type];
                if (e && t) {
                  const i = new CustomEvent(t, { bubbles: !1, cancelable: !1, detail: o.detail });
                  e.dispatchEvent(i);
                }
              });
          }
          ...
          async present() {
            ...
            const e = Object.assign(Object.assign({}, this.componentProps), { popover: this.el });
            return (
              (this.usersElement = await Object(n.a)(
                this.delegate,
                o,
                this.component,
              ...
              await Object(a.f)(this.usersElement),
              Object(s.e)(this, 'popoverEnter', l, v, this.event)
            );
          }
          async dismiss(o, e) {
            const t = await Object(s.g)(this, o, e, 'popoverLeave', h, b, this.event);
            return t && (await Object(n.b)(this.delegate, this.usersElement)), t;
          }
          onDidDismiss() {
          ...
          render() {
            ...
            return Object(i.j)(
              i.c,
              {
                ...
                class: Object.assign(Object.assign({}, Object(p.b)(this.cssClass)), {
                  [o]: !0,
              ...
              Object(i.j)('ion-backdrop', { tappable: this.backdropDismiss, visible: this.showBackdrop }),
              Object(i.j)('div', { tabindex: '0' }),
              Object(i.j)(
                'div',
                { class: 'popover-wrapper ion-overlay-wrapper' },
                Object(i.j)('div', { class: 'popover-arrow' }),
                Object(i.j)('div', { class: 'popover-content' })
              ),
              Object(i.j)('div', { tabindex: '0' })
            );
          }
