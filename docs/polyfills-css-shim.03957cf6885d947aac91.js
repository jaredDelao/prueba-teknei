    ...
    '9qUq': function (t, e) {
      ...
      function s(t) {
        return o(
          (function (t) {
            ...
            for (var r = e, s = 0, o = t.length; s < o; s++)
              if (t[s] === a) {
                r.rules || (r.rules = []);
                var i = r,
                  c = i.rules[i.rules.length - 1] || null;
                ((r = new n()).start = s + 1), (r.parent = i), (r.previous = c), i.rules.push(r);
              } else t[s] === u && ((r.end = s + 1), (r = r.parent || e));
            return e;
          })(
            (t = (function (t) {
      ...
      function o(t, e) {
        ...
        if (((t.parsedCssText = t.cssText = r.trim()), t.parent)) {
          ...
          })((r = e.substring(t.previous ? t.previous.end : t.parent.start, t.start - 1)))).replace(
            c.multipleSpaces,
            ' '
          )).substring(r.lastIndexOf(';') + 1);
          var n = (t.parsedSelector = t.selector = r.trim());
          (t.atRule = 0 === n.indexOf(f)),
            t.atRule
              ? 0 === n.indexOf(p)
                ? (t.type = i.MEDIA_RULE)
                : n.match(c.keyframesRule) &&
                  ((t.type = i.KEYFRAMES_RULE), (t.keyframesName = t.selector.split(c.multipleSpaces).pop()))
              : (t.type = 0 === n.indexOf(l) ? i.MIXIN_RULE : i.STYLE_RULE);
        }
        var s = t.rules;
        if (s) for (var a = 0, u = s.length, h = void 0; a < u && (h = s[a]); a++) o(h, e);
        return t;
      }
      var i = { STYLE_RULE: 1, KEYFRAMES_RULE: 7, MEDIA_RULE: 4, MIXIN_RULE: 1e3 },
        a = '{',
        u = '}',
        c = {
          comments: /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,
      ...
      function y(t, e, r) {
        var n = (function (t, e) {
          ...
          var n = (function (t, e) {
            ...
            o = s[0],
            i = s.slice(1);
          return { start: r.start, end: n, propName: o.trim(), fallback: i.length > 0 ? i.join(',').trim() : void 0 };
        })(t, r);
        if (!n) return e.push(t.substring(r, t.length)), t.length;
        var s = n.propName,
          o = null != n.fallback ? E(n.fallback) : void 0;
        return (
          e.push(t.substring(r, n.start), function (t) {
            return (function (t, e, r) {
              return t[e] ? t[e] : r ? S(r, t) : '';
            })(t, s, o);
          }),
          n.end
        );
      ...
      function E(t) {
        ...
        t = (function (t) {
          ...
          return e;
        })((t = t.replace(d, ''))).replace(g, '');
        for (var r = []; e < t.length; ) e = y(t, r, e);
        return r;
      }
      function w(t) {
        var e = {};
      ...
      function M(t, e) {
        ...
        return (
          t.rules
            .filter(function (t) {
              return t.type === i.STYLE_RULE;
            })
            .forEach(function (t) {
              var n = (function (t) {
                for (var e, r = []; (e = k.exec(t.trim())); ) {
                  var n = C(e[2]),
                    s = n.value,
                    o = n.important;
                  r.push({ prop: e[1].trim(), value: E(s), important: o });
                }
                return r;
              })(t.cssText);
              n.length > 0 &&
                t.parsedSelector.split(',').forEach(function (t) {
                  (t = t.trim()), r.push({ selector: t, declarations: n, specificity: 1, nu: e });
                }),
                e++;
            }),
          r
      ...
      var x = '!important',
        k =
          /(?:^|[;\s{]\s*)(--[\w-]*?)\s*:\s*(?:((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};{])+)|\{([^}]*)\}(?:(?=[;\s}])|$))/gm;
      function C(t) {
        var e = (t = t.replace(/\s+/gim, ' ').trim()).endsWith(x);
        return e && (t = t.substr(0, t.length - x.length).trim()), { value: t, important: e };
      }
      function I(t) {
        var e = [];
        return (
      ...
      function R(t) {
        var e = s(t),
          r = E(t);
        return { original: t, template: r, selectors: M(e), usesCssVars: r.length > 1 };
      }
      function A(t, e) {
        if (
          t.some(function (t) {
          ...
          return !1;
        var r = R(e.textContent);
        return (r.styleEl = e), t.push(r), !0;
      }
      function L(t) {
        var e = w(I(t));
        t.forEach(function (t) {
          t.usesCssVars && (t.styleEl.textContent = S(t.template, e));
        });
      }
      function _(t, e, r) {
        return (function (t, e, r) {
      ...
      function T(t, e, r) {
        ...
        return fetch(n)
          ...
          .then(function (s) {
            if (
              (function (t) {
                return t.indexOf('var(') > -1 || N.test(t);
              })(s) &&
              r.parentNode
            ) {
              (function (t) {
        ...
        P = (function () {
          ...
          return (
                        ...
                        (function (t, e) {
                          return (
                            ...
                            (function (t, e) {
                              for (
                                var r = [],
                                  n = t.querySelectorAll('link[rel="stylesheet"][href]:not([data-no-shim])'),
                                  s = 0;
                                s < n.length;
                                s++
                              )
            ...
            (t.prototype.addLink = function (t) {
              var e = this;
              return T(this.doc, this.globalScopes, t).then(function () {
                e.updateGlobal();
              });
            }),
            (t.prototype.addGlobalStyle = function (t) {
              A(this.globalScopes, t) && this.updateGlobal();
            }),
            (t.prototype.createHostStyle = function (t, e, n, s) {
              if (this.hostScopeMap.has(t)) throw new Error('host style already created');
              var o = this.registerHostTemplate(n, e, s),
                i = this.doc.createElement('style');
              return (
                i.setAttribute('data-no-shim', ''),
                o.usesCssVars
                  ? s
                    ? ((i['s-sc'] = e = o.scopeId + '-' + this.count),
                      (i.textContent = '/*needs update*/'),
                      this.hostStyleMap.set(t, i),
                      this.hostScopeMap.set(
                        t,
                        (function (t, e) {
                          var n = t.template.map(function (r) {
                              return 'string' == typeof r ? _(r, t.scopeId, e) : r;
                            }),
                            s = t.selectors.map(function (n) {
                              return r(r({}, n), { selector: _(n.selector, t.scopeId, e) });
                            });
                      ...
                      this.count++)
                    : ((o.styleEl = i),
                      o.usesCssVars || (i.textContent = S(o.template, {})),
                      this.globalScopes.push(o),
                      this.updateGlobal(),
                      this.hostScopeMap.set(t, o))
                  : (i.textContent = n),
                i
              );
            }),
            ...
            (t.prototype.registerHostTemplate = function (t, e, r) {
              ...
              return n || (((n = R(t)).scopeId = e), (n.isScoped = r), this.scopesMap.set(e, n)), n;
            }),
            t
          );
        })();
      !(U = 'undefined' != typeof window && window) ||
        ...
        (U.__cssshim = new P(U, U.document));
    },
  },
]);
