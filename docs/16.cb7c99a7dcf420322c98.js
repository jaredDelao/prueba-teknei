  ...
  [16],
  {
    Q2Bp: function (o, t, a) {
      ...
      const s = class {
        constructor(o) {
          Object(r.o)(this, o),
            (this.ionBackdropTap = Object(r.g)(this, 'ionBackdropTap', 7)),
            (this.blocker = i.a.createBlocker({ disableScroll: !0 })),
            (this.visible = !0),
            (this.tappable = !0),
        ...
        render() {
          const o = Object(n.b)(this);
          return Object(r.j)(r.c, {
            tabindex: '-1',
            'aria-hidden': 'true',
            class: { [o]: !0, 'backdrop-hide': !this.visible, 'backdrop-no-tappable': !this.tappable },
          });
        }
      };
      s.style = {
