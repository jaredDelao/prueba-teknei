  ...
  [23],
  {
    uQcF: function (t, o, r) {
      ...
      const e = class {
        constructor(t) {
          Object(i.o)(this, t),
            ...
            (this.activated = !1),
            (this.onClick = () => {
              const t = !!this.el.querySelector('ion-fab-list'),
                o = this.getFab();
              t && (!o || !o.disabled) && (this.activated = !this.activated);
            });
        }
        activatedChanged() {
          const t = this.activated,
            o = this.getFab();
          o && (o.activated = t),
            Array.from(this.el.querySelectorAll('ion-fab-list')).forEach((o) => {
              o.activated = t;
            });
        }
        componentDidLoad() {
        ...
        render() {
          const { horizontal: t, vertical: o, edge: r } = this,
            n = Object(a.b)(this);
          return Object(i.j)(
            i.c,
            {
      ...
      const s = class {
        ...
        render() {
          const { el: t, disabled: o, color: r, href: e, activated: s, show: c, translucent: l, size: b } = this,
            d = Object(n.c)('ion-fab-list', t),
            p = Object(a.b)(this),
            g = void 0 === e ? 'button' : 'a',
            h =
              'button' === g
                ? { type: this.type }
                : { download: this.download, href: e, rel: this.rel, target: this.target };
          return Object(i.j)(
            i.c,
            {
              ...
              class: Object(n.a)(r, {
                ...
                'fab-button-translucent-in-list': d && l,
                'fab-button-close-active': s,
                'fab-button-show': c,
                'fab-button-disabled': o,
                'fab-button-translucent': l,
                'ion-activatable': !0,
                'ion-focusable': !0,
                ['fab-button-' + b]: void 0 !== b,
              }),
            },
            Object(i.j)(
              g,
              Object.assign({}, h, {
                ...
                onBlur: this.onBlur,
                onClick: (t) => Object(n.d)(e, t, this.routerDirection, this.routerAnimation),
              }),
              Object(i.j)('ion-icon', { icon: this.closeIcon, part: 'close-icon', class: 'close-icon', lazy: !1 }),
              Object(i.j)('span', { class: 'button-inner' }, Object(i.j)('slot', null)),
              'md' === p && Object(i.j)('ion-ripple-effect', null)
            )
          );
        }
        get el() {
      ...
      const c = class {
        constructor(t) {
          Object(i.o)(this, t), (this.activated = !1), (this.side = 'bottom');
        }
        activatedChanged(t) {
          const o = Array.from(this.el.querySelectorAll('ion-fab-button')),
            r = t ? 30 : 0;
          o.forEach((o, i) => {
            setTimeout(() => (o.show = t), i * r);
          });
        }
        render() {
          ...
          return Object(i.j)(
            i.c,
            { class: { [t]: !0, 'fab-list-active': this.activated, ['fab-list-side-' + this.side]: !0 } },
            Object(i.j)('slot', null)
          );
        }
        get el() {
