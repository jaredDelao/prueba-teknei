  ...
  [28],
  {
    MGMP: function (t, i, e) {
      ...
      const a = class {
        constructor(t) {
          Object(n.o)(this, t),
            ...
            (this.type = 'button'),
            (this.onClick = (t) => {
              t.target.closest('ion-item-option') && t.preventDefault();
            });
        }
        render() {
          const { disabled: t, expandable: i, href: e } = this,
            ...
            a = Object(o.b)(this),
            l =
              'button' === r ? { type: this.type } : { download: this.download, href: this.href, target: this.target };
          return Object(n.j)(
            n.c,
            {
              onClick: this.onClick,
              class: Object(s.a)(this.color, {
                [a]: !0,
            ...
            Object(n.j)(
              r,
              Object.assign({}, l, { class: 'button-native', part: 'native', disabled: t }),
              Object(n.j)(
                'span',
                { class: 'button-inner' },
                Object(n.j)('slot', { name: 'top' }),
                Object(n.j)(
                  'div',
                  { class: 'horizontal-wrapper' },
                  Object(n.j)('slot', { name: 'start' }),
                  Object(n.j)('slot', { name: 'icon-only' }),
                  Object(n.j)('slot', null),
                  Object(n.j)('slot', { name: 'end' })
                ),
                Object(n.j)('slot', { name: 'bottom' })
              ),
              'md' === a && Object(n.j)('ion-ripple-effect', null)
            )
          );
        }
        get el() {
      ...
      const l = class {
        ...
        render() {
          const t = Object(o.b)(this),
            i = Object(r.m)(this.side);
          return Object(n.j)(n.c, {
            class: { [t]: !0, ['item-options-' + t]: !0, 'item-options-start': !i, 'item-options-end': i },
          });
        }
        get el() {
          return Object(n.k)(this);
      ...
      const p = class {
          constructor(t) {
            Object(n.o)(this, t),
              (this.ionDrag = Object(n.g)(this, 'ionDrag', 7)),
              (this.item = null),
              (this.openAmount = 0),
          ...
          async connectedCallback() {
            (this.item = this.el.querySelector('ion-item')),
              ...
              (this.gesture = (await Promise.resolve().then(e.bind(null, 'KF81'))).createGesture({
                el: this.el,
          ...
          async open(t) {
            ...
            i &&
              (void 0 === t && (t = i === this.leftOptions ? 'start' : 'end'),
              (t = Object(r.m)(t) ? 'end' : 'start'),
              (this.openAmount < 0 && i === this.leftOptions) ||
                (this.openAmount > 0 && i === this.rightOptions) ||
                (this.closeOpened(),
                (this.state = 4),
                requestAnimationFrame(() => {
                  this.calculateOptsWidth(),
                    (d = this.el),
                    this.setOpenAmount('end' === t ? this.optsWidthRightSide : -this.optsWidthLeftSide, !1),
          ...
          async updateOptions() {
            ...
            for (let e = 0; e < t.length; e++) {
              const n = t.item(e),
                o = void 0 !== n.componentOnReady ? await n.componentOnReady() : n;
              'start' == (Object(r.m)(o.side) ? 'end' : 'start')
                ? ((this.leftOptions = o), (i |= 1))
                : ((this.rightOptions = o), (i |= 2));
            }
            (this.optsDirty = !0), (this.sides = i);
          }
          canStart(t) {
            return !(
              ('rtl' === document.dir ? window.innerWidth - t.startX < 15 : t.startX < 15) ||
              (d && d !== this.el && this.closeOpened(), !this.rightOptions && !this.leftOptions)
            );
          }
          disableContentScrollY() {
            null !== this.closestContent &&
              ((this.initialContentScrollY = this.closestContent.scrollY), (this.closestContent.scrollY = !1));
          }
          restoreContentScrollY() {
            null !== this.closestContent && (this.closestContent.scrollY = this.initialContentScrollY);
          }
          onStart() {
          ...
          onMove(t) {
            ...
            e > this.optsWidthRightSide
              ? ((i = this.optsWidthRightSide), (e = i + 0.55 * (e - i)))
              : e < -this.optsWidthLeftSide && ((i = -this.optsWidthLeftSide), (e = i + 0.55 * (e - i))),
              this.setOpenAmount(e, !1);
          }
          onEnd(t) {
            this.restoreContentScrollY();
            const i = t.velocityX;
            let e = this.openAmount > 0 ? this.optsWidthRightSide : -this.optsWidthLeftSide;
            const n = this.openAmount > 0 == !(i < 0),
              o = Math.abs(i) > 0.3,
              s = Math.abs(this.openAmount) < Math.abs(e / 2);
            m(n, o, s) && (e = 0);
            const r = this.state;
            this.setOpenAmount(e, !0),
              0 != (32 & r) && this.rightOptions
                ? this.rightOptions.fireSwipeEvent()
                : 0 != (64 & r) && this.leftOptions && this.leftOptions.fireSwipeEvent();
          }
          calculateOptsWidth() {
            (this.optsWidthRightSide = 0),
              this.rightOptions &&
          ...
          setOpenAmount(t, i) {
            ...
            if (((this.openAmount = t), i && (e.transition = ''), t > 0))
            ...
            (e.transform = `translate3d(${-t}px,0,0)`),
              this.ionDrag.emit({ amount: t, ratio: this.getSlidingRatioSync() });
          }
          getSlidingRatioSync() {
