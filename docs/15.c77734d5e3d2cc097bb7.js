(window.webpackJsonp = window.webpackJsonp || []).push([
  [15],
  {
    Nt02: function (t, n, i) {
      'use strict';
      i.r(n),
        i.d(n, 'ion_back_button', function () {
          return e;
        });
      var o = i('wEJo'),
        r = i('E/Mt'),
      ...
      const e = class {
          ...
          Object(o.o)(this, t),
            ...
            (this.onClick = async (t) => {
              ...
              return (
                t.preventDefault(),
                n && (await n.canGoBack())
                  ? n.pop({ animationBuilder: this.routerAnimation, skipIfBusy: !0 })
                  : Object(a.d)(this.defaultHref, t, 'back', this.routerAnimation)
              );
            });
        }
        componentWillLoad() {
          void 0 === this.defaultHref && (this.defaultHref = r.c.get('backButtonDefaultHref'));
        }
        get backButtonIcon() {
          const t = this.icon;
          return null != t
            ? t
            : 'ios' === Object(r.b)(this)
            ? r.c.get('backButtonIcon', 'chevron-back')
            : r.c.get('backButtonIcon', 'arrow-back-sharp');
        }
        get backButtonText() {
          const t = 'ios' === Object(r.b)(this) ? 'Back' : null;
          return null != this.text ? this.text : r.c.get('backButtonText', t);
        }
        get hasIconOnly() {
        ...
        render() {
          ...
          return Object(o.j)(
            ...
            Object(o.j)(
              'button',
              { type: e, disabled: i, class: 'button-native', part: 'native', 'aria-label': c || 'back' },
              Object(o.j)(
                'span',
                { class: 'button-inner' },
                s && Object(o.j)('ion-icon', { part: 'icon', icon: s, 'aria-hidden': 'true', lazy: !1 }),
                c && Object(o.j)('span', { part: 'text', 'aria-hidden': 'true', class: 'button-text' }, c)
              ),
              'md' === l && Object(o.j)('ion-ripple-effect', { type: this.rippleType })
            )
          );
        }
        get el() {
