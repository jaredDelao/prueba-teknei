    ...
    NAQR: function (e, i, t) {
      ...
      const o = 'split-pane-main',
        ...
        l = class {
          constructor(e) {
            Object(s.o)(this, e),
              (this.ionSplitPaneVisible = Object(s.g)(this, 'ionSplitPaneVisible', 7)),
              (this.visible = !1),
              (this.disabled = !1),
              (this.when = d.lg);
          }
          visibleChanged(e) {
            const i = { visible: e, isPane: this.isPane.bind(this) };
          ...
          updateState() {
            ...
            if (0 !== i.length) {
              if (window.matchMedia) {
                ...
                t.addListener(e), (this.rmL = () => t.removeListener(e)), (this.visible = t.matches);
              }
            } else this.visible = !1;
          }
          isPane(e) {
            return !!this.visible && e.parentElement === this.el && e.classList.contains(n);
          }
          styleChildren() {
          ...
          render() {
            ...
            return Object(s.j)(
              s.c,
              { class: { [e]: !0, ['split-pane-' + e]: !0, 'split-pane-visible': this.visible } },
          ...
          static get watchers() {
            return { visible: ['visibleChanged'], disabled: ['updateState'], when: ['updateState'] };
          }
        },
        a = (e, i) => {
          let t, s;
