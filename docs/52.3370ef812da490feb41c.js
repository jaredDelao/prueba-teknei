  ...
  [52],
  {
    IUOf: function (t, e, n) {
      ...
      const s = class {
          constructor(t) {
            Object(i.o)(this, t),
              (this.ionChange = Object(i.g)(this, 'ionChange', 7)),
              ...
              (this.value = 'on'),
              (this.onClick = (t) => {
                t.preventDefault(), this.lastDrag + 300 < Date.now() && (this.checked = !this.checked);
              }),
              (this.onFocus = () => {
                this.ionFocus.emit();
              }),
          ...
          async connectedCallback() {
            (this.gesture = (await Promise.resolve().then(n.bind(null, 'KF81'))).createGesture({
              el: this.el,
              gestureName: 'toggle',
              gesturePriority: 100,
              threshold: 5,
          ...
          onMove(t) {
            l(document, this.checked, t.deltaX, -10) && ((this.checked = !this.checked), Object(r.c)());
          }
          onEnd(t) {
            (this.activated = !1),
          ...
          render() {
            const { activated: t, color: e, checked: n, disabled: r, el: s, inputId: l, name: c } = this,
              g = Object(a.b)(this),
              { label: h, labelId: p, labelText: b } = Object(o.d)(s, l),
              u = this.getValue();
            return (
              Object(o.e)(!0, s, c, n ? u : '', r),
              Object(i.j)(
                i.c,
                {
                  onClick: this.onClick,
                  'aria-labelledby': h ? p : null,
                  'aria-checked': '' + n,
                  'aria-hidden': r ? 'true' : null,
                  role: 'switch',
                  class: Object(d.a)(e, {
                    [g]: !0,
                    'in-item': Object(d.c)('ion-item', s),
                    'toggle-activated': t,
                    'toggle-checked': n,
                    'toggle-disabled': r,
                    interactive: !0,
                ...
                Object(i.j)(
                  'div',
                  { class: 'toggle-icon', part: 'track' },
                  Object(i.j)(
                    'div',
                    { class: 'toggle-icon-wrapper' },
                    Object(i.j)('div', { class: 'toggle-inner', part: 'handle' })
                  )
                ),
                Object(i.j)('label', { htmlFor: l }, b),
                Object(i.j)('input', {
                  type: 'checkbox',
                  role: 'switch',
                  'aria-checked': '' + n,
