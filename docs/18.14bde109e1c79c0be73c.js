    ...
    '0Pbj': function (o, t, n) {
      ...
      const l = (o, t, n, i, r) => (
          ...
          i && 'ios' === n
            ...
            : r && 'md' === n
            ? (o = u(r))
            : (o || !t || d(t) || (o = t), b(o) && (o = u(o))),
          b(o) && '' !== o.trim() ? ('' !== o.replace(/[a-z]|-|\d/gi, '') ? null : o) : null
        ),
        ...
        h = class {
          constructor(o) {
            Object(i.o)(this, o),
              (this.ionFocus = Object(i.g)(this, 'ionFocus', 7)),
              (this.ionBlur = Object(i.g)(this, 'ionBlur', 7)),
              (this.inItem = !1),
              (this.inListHeader = !1),
              (this.inToolbar = !1),
              ...
              (this.type = 'button'),
              (this.handleClick = (o) => {
                if ('button' === this.type) Object(a.d)(this.href, o, this.routerDirection, this.routerAnimation);
                else if (Object(e.k)(this.el)) {
          ...
          componentWillLoad() {
            (this.inToolbar = !!this.el.closest('ion-buttons')),
              ...
              (this.inheritedAttributes = Object(e.i)(this.el, ['aria-label']));
          }
          get hasIconOnly() {
          ...
          render() {
            const o = Object(r.b)(this),
              ...
              m = void 0 === c && this.inItem ? 'small' : c,
              f = void 0 === d ? 'button' : 'a',
              k = 'button' === f ? { type: n } : { download: this.download, href: d, rel: s, target: l };
            let w = this.fill;
            return (
              void 0 === w && (w = this.inToolbar || this.inListHeader ? 'clear' : 'solid'),
              Object(i.j)(
                i.c,
                {
                ...
                Object(i.j)(
                  ...
                  Object.assign(
                    {},
                    k,
                    { class: 'button-native', part: 'native', disabled: e, onFocus: this.onFocus, onBlur: this.onBlur },
                    v
                  ),
                  Object(i.j)(
                    'span',
                    { class: 'button-inner' },
                    Object(i.j)('slot', { name: 'icon-only' }),
                    Object(i.j)('slot', { name: 'start' }),
                    Object(i.j)('slot', null),
                    Object(i.j)('slot', { name: 'end' })
                  ),
                  'md' === o && Object(i.j)('ion-ripple-effect', { type: this.rippleType })
                )
              )
            );
          }
      ...
      const g = (o) => {
          if (1 === o.nodeType) {
            ...
            for (let t = 0; t < o.attributes.length; t++) {
              ...
              if (b(n) && 0 === n.toLowerCase().indexOf('on')) return !1;
            }
            for (let t = 0; t < o.childNodes.length; t++) if (!g(o.childNodes[t])) return !1;
          }
          return !0;
        },
        p = new Map(),
          ...
          loadIcon() {
            if (this.isVisible) {
              const o = ((o) => {
                let t = c(o.src);
                if (t) return t;
                if (((t = l(o.name, o.icon, o.mode, o.ios, o.md)), t))
                  return (
                    (n = t),
                    (() => {
                      ...
                      if (!s) {
                        const o = window;
                        (o.Ionicons = o.Ionicons || {}), (s = o.Ionicons.map = o.Ionicons.map || new Map());
                      }
                      return s;
                    })().get(n) || Object(i.m)(`svg/${n}.svg`)
                  );
                var n;
                if (o.icon) {
                  ...
                  : ((o, t) => {
                      ...
                      if (!n) {
                        if ('undefined' == typeof fetch || 'undefined' == typeof document)
                          return p.set(o, ''), Promise.resolve();
                        (n = fetch(o).then((n) => {
                          if (n.ok)
                              ...
                              n &&
                                ...
                                (n = ((o) => {
                                  ...
                                  if (n && 'svg' === n.nodeName.toLowerCase()) {
                                    ...
                                    if ((n.setAttribute('class', (o + ' s-ion-icon').trim()), g(n))) return t.innerHTML;
                                  }
                                  return '';
                                })(n)),
                                p.set(o, n || '');
                      ...
                      return n;
                    })(o, this.sanitize).then(() => (this.svgContent = p.get(o))));
            }
            const o = (this.iconName = l(this.name, this.icon, this.mode, this.ios, this.md));
            this.ariaLabel || 'true' === this.ariaHidden || (o && (this.ariaLabel = o.replace(/\-/g, ' ')));
          }
          render() {
            const { iconName: o } = this,
              t = this.mode || 'md',
              n = this.flipRtl || (o && (o.indexOf('arrow') > -1 || o.indexOf('chevron') > -1) && !1 !== this.flipRtl);
            return Object(i.j)(
              i.c,
              {
                role: 'img',
                class: Object.assign(Object.assign({ [t]: !0 }, k(this.color)), {
                  ['icon-' + this.size]: !!this.size,
                  'flip-rtl': !!n && 'rtl' === this.el.ownerDocument.dir,
                }),
              },
              this.svgContent
                ? Object(i.j)('div', { class: 'icon-inner', innerHTML: this.svgContent })
                : Object(i.j)('div', { class: 'icon-inner' })
            );
          }
        ...
        f = () => ('undefined' != typeof document && document.documentElement.getAttribute('mode')) || 'md',
