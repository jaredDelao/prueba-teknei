  ...
  [11],
  {
    dUtr: function (t, o, e) {
      ...
      var n = e('wEJo'),
        ...
        s = e('74mu'),
        c = e('meiF');
      e('qULd'), e('KF81'), e('y08P'), e('B4Jq'), e('1vRN');
      const d = (t) => {
          const o = Object(c.a)(),
            e = Object(c.a)(),
            n = Object(c.a)();
          return (
            ...
            o.addElement(t).easing('cubic-bezier(.36,.66,.04,1)').duration(400).addAnimation([e, n])
          );
        },
        l = (t) => {
          const o = Object(c.a)(),
            ...
            n = Object(c.a)();
          return (
            e.addElement(t.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0),
            n
              .addElement(t.querySelector('.action-sheet-wrapper'))
              .fromTo('transform', 'translateY(0%)', 'translateY(100%)'),
            o.addElement(t).easing('cubic-bezier(.36,.66,.04,1)').duration(450).addAnimation([e, n])
          );
        },
        b = (t) => {
          const o = Object(c.a)(),
        ...
        g = class {
          constructor(t) {
            Object(n.o)(this, t),
              (this.didPresent = Object(n.g)(this, 'ionActionSheetDidPresent', 7)),
              (this.willPresent = Object(n.g)(this, 'ionActionSheetWillPresent', 7)),
              (this.willDismiss = Object(n.g)(this, 'ionActionSheetWillDismiss', 7)),
              (this.didDismiss = Object(n.g)(this, 'ionActionSheetDidDismiss', 7)),
              (this.presented = !1),
          ...
          present() {
            return Object(r.e)(this, 'actionSheetEnter', d, b);
          }
          connectedCallback() {
            Object(r.f)(this.el);
          }
          dismiss(t, o) {
            return Object(r.g)(this, t, o, 'actionSheetLeave', l, h);
          }
          onDidDismiss() {
            return Object(r.h)(this.el, 'ionActionSheetDidDismiss');
          }
          onWillDismiss() {
            return Object(r.h)(this.el, 'ionActionSheetWillDismiss');
          }
          async buttonClick(t) {
            const o = t.role;
            return Object(r.j)(o)
          ...
          async callButtonHandler(t) {
            return !t || !1 !== (await Object(r.n)(t.handler));
          }
          getButtons() {
          ...
          componentDidLoad() {
            const { groupEl: t, wrapperEl: o } = this;
            !this.gesture &&
              'md' !== Object(i.b)(this) &&
              o &&
              t &&
              Object(n.h)(() => {
                t.scrollHeight > t.clientHeight ||
                  ((this.gesture = Object(a.a)(o, (t) => t.classList.contains('action-sheet-button'))),
          ...
          render() {
            ...
            return Object(n.j)(
              n.c,
              {
                ...
                class: Object.assign(Object.assign({ [t]: !0 }, Object(s.b)(this.cssClass)), {
                  'action-sheet-translucent': this.translucent,
                }),
                onIonActionSheetWillDismiss: this.dispatchCancelHandler,
                onIonBackdropTap: this.onBackdropTap,
              },
              Object(n.j)('ion-backdrop', { tappable: this.backdropDismiss }),
              Object(n.j)('div', { tabindex: '0' }),
              Object(n.j)(
                'div',
                { class: 'action-sheet-wrapper ion-overlay-wrapper', role: 'dialog', ref: (t) => (this.wrapperEl = t) },
                Object(n.j)(
                  'div',
                  { class: 'action-sheet-container' },
                  Object(n.j)(
                    'div',
                    { class: 'action-sheet-group', ref: (t) => (this.groupEl = t) },
                    void 0 !== this.header &&
                      Object(n.j)(
                        'div',
                        {
                          class: { 'action-sheet-title': !0, 'action-sheet-has-sub-title': void 0 !== this.subHeader },
                        },
                        this.header,
                        this.subHeader && Object(n.j)('div', { class: 'action-sheet-sub-title' }, this.subHeader)
                      ),
                    a.map((o) =>
                      Object(n.j)(
                        'button',
                        { type: 'button', class: u(o), onClick: () => this.buttonClick(o) },
                        Object(n.j)(
                          'span',
                          { class: 'action-sheet-button-inner' },
                          o.icon && Object(n.j)('ion-icon', { icon: o.icon, lazy: !1, class: 'action-sheet-icon' }),
                          o.text
                        ),
                        'md' === t && Object(n.j)('ion-ripple-effect', null)
                      )
                    )
                  ),
                  e &&
                    Object(n.j)(
                      ...
                      Object(n.j)(
                        'button',
                        { type: 'button', class: u(e), onClick: () => this.buttonClick(e) },
                        Object(n.j)(
                          'span',
                          { class: 'action-sheet-button-inner' },
                          e.icon && Object(n.j)('ion-icon', { icon: e.icon, lazy: !1, class: 'action-sheet-icon' }),
                          e.text
                        ),
                        'md' === t && Object(n.j)('ion-ripple-effect', null)
                      )
