  ...
  [42],
  {
    fSgp: function (t, e, o) {
      ...
      const s = class {
        constructor(t) {
          Object(n.o)(this, t),
            ...
            (this.ionSelect = Object(n.g)(this, 'ionSelect', 7)),
            ...
            (this.onClick = (t) => {
              const e = t.target,
                o = this.checked;
              'ION-SEGMENT' !== e.tagName &&
                ((this.value = e.value),
                (!this.scrollable && this.swipeGesture) || (o ? this.checkButton(o, e) : this.setCheckedClasses()),
                (this.checked = e));
            });
        }
        colorChanged(t, e) {
          ((void 0 === e && void 0 !== t) || (void 0 !== e && void 0 === t)) && this.emitStyle();
        }
        swipeGestureChanged() {
          this.gestureChanged();
        }
        valueChanged(t, e) {
          this.ionSelect.emit({ value: t }),
            ('' !== e || this.didInit) &&
              (this.activated ? (this.valueAfterGesture = t) : this.ionChange.emit({ value: t }));
        }
        disabledChanged() {
          this.gestureChanged();
        ...
        async componentDidLoad() {
          this.setCheckedClasses(),
            (this.gesture = (await Promise.resolve().then(o.bind(null, 'KF81'))).createGesture({
              el: this.el,
              gestureName: 'segment',
              gesturePriority: 100,
              threshold: 0,
        ...
        onEnd(t) {
          ...
          void 0 !== o && (this.ionChange.emit({ value: o }), (this.valueAfterGesture = void 0));
        }
        getButtons() {
          return Array.from(this.el.querySelectorAll('ion-segment-button'));
        }
        addRipple(t) {
          if (!i.c.getBoolean('animated', !0) || !i.c.getBoolean('rippleEffect', !0)) return;
          const e = this.getButtons().find((t) => t.value === this.value),
            o = (e.shadowRoot || e).querySelector('ion-ripple-effect');
          if (!o) return;
          const { x: n, y: a } = Object(r.p)(t.event);
          o.addRipple(n, a).then((t) => t());
        }
        setActivated(t) {
          this.getButtons().forEach((e) => {
            t ? e.classList.add('segment-button-activated') : e.classList.remove('segment-button-activated');
          }),
            (this.activated = t);
        }
        activate(t) {
          const e = t.event.target,
            o = this.getButtons().find((t) => t.value === this.value);
          'ION-SEGMENT-BUTTON' === e.tagName &&
            (o || ((this.value = e.value), this.setCheckedClasses()), this.value === e.value && this.setActivated(!0));
        }
        getIndicator(t) {
        ...
        checkButton(t, e) {
          ...
          Object(n.f)(() => {
            i.classList.remove('segment-button-indicator-animated'),
              ...
              i.classList.add('segment-button-indicator-animated'),
        ...
        setCheckedClasses() {
          ...
          e < t.length && t[e].classList.add('segment-button-after-checked');
        }
        setNextIndex(t, e = !1) {
          ...
          const c = a.getBoundingClientRect(),
            ...
            g = c.width,
            b = t.currentX,
            h = document.elementFromPoint(b, c.top + c.height / 2);
          if (n && !e) {
            if (o ? b > d + g : b < d) {
              const t = r - 1;
              t >= 0 && (l = t);
            } else if ((o ? b < d : b > d + g) && n && !e) {
              const t = r + 1;
              t < i.length && (l = t);
            }
      ...
      s.style = {
        ...
        md: ':host{--ripple-color:currentColor;-moz-osx-font-smoothing:grayscale;-webkit-font-smoothing:antialiased;display:-ms-flexbox;display:flex;position:relative;-ms-flex-align:stretch;align-items:stretch;-ms-flex-pack:center;justify-content:center;width:100%;background:var(--background);font-family:var(--ion-font-family, inherit);text-align:center;contain:paint;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}:host(.segment-scrollable){-ms-flex-pack:start;justify-content:start;width:auto;overflow-x:auto}:host(.segment-scrollable::-webkit-scrollbar){display:none}:host{--background:transparent}:host(.segment-scrollable) ::slotted(ion-segment-button){min-width:auto}',
      };
      let l = 0;
      const c = class {
        constructor(t) {
        ...
        connectedCallback() {
          ...
          t &&
            (this.updateState(),
            Object(r.a)(t, 'ionSelect', this.updateState),
            Object(r.a)(t, 'ionStyle', this.updateStyle));
        }
        disconnectedCallback() {
          const t = this.segmentEl;
          t &&
            (Object(r.b)(t, 'ionSelect', this.updateState),
            Object(r.b)(t, 'ionStyle', this.updateStyle),
            (this.segmentEl = null));
        }
        get hasLabel() {
        ...
        get tabIndex() {
          return this.disabled ? -1 : this.el.hasAttribute('tabindex') ? this.el.getAttribute('tabindex') : 0;
        }
        render() {
          const {
              checked: t,
          ...
          return Object(n.j)(
            n.c,
            {
              ...
              class: {
                ...
                'in-segment-color': null !== c && void 0 !== c.color,
                'segment-button-has-label': s,
                'segment-button-has-icon': r,
                'segment-button-has-label-only': s && !r,
                'segment-button-has-icon-only': r && !s,
            ...
            Object(n.j)(
              'button',
              { type: e, tabIndex: -1, class: 'button-native', part: 'native', disabled: o },
              Object(n.j)('span', { class: 'button-inner' }, Object(n.j)('slot', null)),
              'md' === g && Object(n.j)('ion-ripple-effect', null)
            ),
            Object(n.j)(
              'div',
              { part: 'indicator', class: { 'segment-button-indicator': !0, 'segment-button-indicator-animated': !0 } },
              Object(n.j)('div', { part: 'indicator-background', class: 'segment-button-indicator-background' })
            )
          );
        }
        get el() {
