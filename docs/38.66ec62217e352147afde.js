    ...
    nYbb: function (e, r, t) {
      ...
      const c = (e) => {
          const r = e.querySelector('ion-spinner'),
            ...
            o = Object(l.a)().duration(1e3).easing('ease-out'),
            a = Object(l.a)()
              .addElement(s)
              .keyframes([
        ...
        g = async (e, r) => {
          const t = e.querySelector('ion-refresher-content');
          if (!t) return Promise.resolve(!1);
          await new Promise((e) => Object(o.c)(t, e));
          const s = e.querySelector('ion-refresher-content .refresher-pulling ion-spinner'),
            n = e.querySelector('ion-refresher-content .refresher-refreshing ion-spinner');
          return (
            null !== s &&
            null !== n &&
            (('ios' === r && Object(i.a)('mobile') && void 0 !== e.style.webkitOverflowScrolling) || 'md' === r)
          );
        },
        m = (e, r = 0) =>
          new Promise((t) => {
        ...
        u = (e, r = 0, t) => {
          ...
          const n = { passive: !0 },
            ...
            a = (r) => {
              (void 0 !== r && e !== r.target) || (o(), t(r));
            };
          return (
            e &&
              (e.addEventListener('webkitTransitionEnd', a, n),
              e.addEventListener('transitionend', a, n),
              (i = setTimeout(a, r + 500)),
              (s = () => {
                i && (clearTimeout(i), (i = void 0)),
                  e.removeEventListener('webkitTransitionEnd', a, n),
                  e.removeEventListener('transitionend', a, n);
              })),
            o
          );
        },
        b = class {
          constructor(e) {
            Object(s.o)(this, e),
              (this.ionRefresh = Object(s.g)(this, 'ionRefresh', 7)),
              (this.ionPull = Object(s.g)(this, 'ionPull', 7)),
              (this.ionStart = Object(s.g)(this, 'ionStart', 7)),
          ...
          async checkNativeRefresher() {
            const e = await g(this.el, Object(i.b)(this));
          ...
          async resetNativeRefresher(e, r) {
            (this.state = r),
              'ios' === Object(i.b)(this)
                ? await p(e, void 0)
                : await m(this.el.querySelector('.refresher-refreshing-icon'), 200),
              (this.didRefresh = !1),
              (this.needsCompletion = !1),
              (this.pointerDown = !1),
          ...
          async setupiOSNativeRefresher(e, r) {
            this.elementToTransform = this.scrollEl;
            const i = e.shadowRoot.querySelectorAll('svg');
            let n = 0.16 * this.scrollEl.clientHeight;
            const l = i.length;
            Object(s.f)(() => i.forEach((e) => e.style.setProperty('animation', 'none'))),
              (this.scrollListenerCallback = () => {
                (this.pointerDown || 1 !== this.state) &&
                  Object(s.h)(() => {
                    ...
                    if (t > 0) {
                      if (8 === this.state) {
                        const e = Object(o.j)(0, t / (0.5 * h), 1);
                        return void Object(s.f)(() => d(r, 1 - e));
                      }
                      return void Object(s.f)(() => d(e, 0));
                    }
                    this.pointerDown &&
                      (this.didStart || ((this.didStart = !0), this.ionStart.emit()),
                      this.pointerDown && this.ionPull.emit());
                    const f = Object(o.j)(0, Math.abs(t) / h, 0.99),
                      c = (this.progress = Object(o.j)(0, (Math.abs(t) - 30) / n, 1)),
                      g = Object(o.j)(0, Math.floor(c * l), l - 1);
                    var m, u;
                    8 === this.state || g === l - 1
                      ? (this.pointerDown &&
                          ((m = r),
                          ...
                          Object(s.f)(() => {
                            m.style.setProperty('--refreshing-rotation-duration', u >= 1 ? '0.5s' : '2s'),
                              m.style.setProperty('opacity', '1');
                          })),
                        this.didRefresh ||
                          (this.beginRefresh(),
                          (this.didRefresh = !0),
                          Object(a.d)({ style: 'light' }),
                          this.pointerDown || p(this.elementToTransform, h + 'px')))
                      : ((this.state = 2),
                        ((e, r, t, i) => {
                          Object(s.f)(() => {
                            d(e, t), r.forEach((e, r) => e.style.setProperty('opacity', r <= i ? '0.99' : '0'));
                          });
                        })(e, i, f, g));
                  });
              }),
              this.scrollEl.addEventListener('scroll', this.scrollListenerCallback),
              (this.gesture = (await Promise.resolve().then(t.bind(null, 'KF81'))).createGesture({
                el: this.scrollEl,
                ...
                onStart: () => {
                  (this.pointerDown = !0),
                    this.didRefresh || p(this.elementToTransform, '0px'),
                    0 === n && (n = 0.16 * this.scrollEl.clientHeight);
                },
                onMove: (e) => {
                ...
                onEnd: () => {
                  (this.pointerDown = !1),
                    ...
                    this.needsCompletion
                      ? (this.resetNativeRefresher(this.elementToTransform, 32), (this.needsCompletion = !1))
                      : this.didRefresh && Object(s.h)(() => p(this.elementToTransform, this.el.clientHeight + 'px'));
                },
              })),
              this.disabledChanged();
          }
          async setupMDNativeRefresher(e, r, i) {
            const a = Object(o.g)(r).querySelector('circle'),
              h = this.el.querySelector('ion-refresher-content .refresher-pulling-icon'),
              f = Object(o.g)(i).querySelector('circle');
            null !== a &&
              null !== f &&
              Object(s.f)(() => {
                a.style.setProperty('animation', 'none'),
                  i.style.setProperty('animation-delay', '-655ms'),
                  f.style.setProperty('animation-delay', '-655ms');
              }),
              (this.gesture = (await Promise.resolve().then(t.bind(null, 'KF81'))).createGesture({
                el: this.scrollEl,
                gestureName: 'refresher',
                ...
                onMove: (r) => {
                  if ((r.velocityY < 0 && 0 === this.progress && !r.data.didStart) || r.data.cancelled)
                    r.data.cancelled = !0;
                  else {
                    if (!r.data.didStart) {
                      (r.data.didStart = !0),
                        (this.state = 2),
                        Object(s.f)(() => this.scrollEl.style.setProperty('--overflow', 'hidden'));
                      const t = ((e, r, t) =>
                        'scale' === e
                          ? ((e, r) => {
                              const t = r.clientHeight,
                                s = Object(l.a)()
                                  .addElement(e)
                                  .keyframes([
                                    { offset: 0, transform: `scale(0) translateY(-${t}px)` },
                                    { offset: 1, transform: 'scale(1) translateY(100px)' },
                                  ]);
                              return c(e).addAnimation([s]);
                            })(r, t)
                          : ((e, r) => {
                              const t = r.clientHeight,
                                s = Object(l.a)()
                                  .addElement(e)
                                  .keyframes([
                                    { offset: 0, transform: `translateY(-${t}px)` },
                      ...
                      return (
                        ...
                        t.progressStart(!1, 0),
                        this.ionStart.emit(),
                        void this.animations.push(t)
                      );
                    }
                    (this.progress = Object(o.j)(0, (r.deltaY / 180) * 0.5, 1)),
                ...
                onEnd: (e) => {
                  ...
                  if ((Object(s.f)(() => this.scrollEl.style.removeProperty('--overflow')), this.progress <= 0.4))
                    return (
                      this.gesture.enable(!1),
                      void e.data.animation.progressEnd(0, this.progress, 500).onFinish(() => {
                        this.animations.forEach((e) => e.destroy()),
                          (this.animations = []),
                  ...
                  const r = Object(n.a)([0, 0], [0, 0], [1, 1], [1, 1], this.progress)[0],
                    t = ((e) =>
                      Object(l.a)()
                        .duration(125)
                        .addElement(e)
                  ...
                  this.animations.push(t),
                    Object(s.f)(async () => {
                      h.style.setProperty('--ion-pulling-refresher-translate', 100 * r + 'px'),
          ...
          async setupNativeRefresher(e) {
            ...
            'ios' === Object(i.b)(this) ? this.setupiOSNativeRefresher(r, t) : this.setupMDNativeRefresher(e, r, t);
          }
          componentDidUpdate() {
          ...
          async connectedCallback() {
            if ('fixed' !== this.el.getAttribute('slot'))
              return void console.error('Make sure you use: <ion-refresher slot="fixed">');
            const e = this.el.closest('ion-content');
            e
              ? (await new Promise((r) => Object(o.c)(e, r)),
                (this.scrollEl = await e.getScrollElement()),
                (this.backgroundContentEl = Object(o.g)(e).querySelector('#background-content')),
                (await g(this.el, Object(i.b)(this)))
                  ? this.setupNativeRefresher(e)
                  : ((this.gesture = (await Promise.resolve().then(t.bind(null, 'KF81'))).createGesture({
                      el: e,
                      gestureName: 'refresher',
          ...
          async complete() {
            this.nativeRefresher
              ? ((this.needsCompletion = !0),
                this.pointerDown ||
                  Object(o.q)(() => Object(o.q)(() => this.resetNativeRefresher(this.elementToTransform, 32))))
              : this.close(32, '120ms');
          }
          async cancel() {
            this.nativeRefresher
              ? this.pointerDown ||
                Object(o.q)(() => Object(o.q)(() => this.resetNativeRefresher(this.elementToTransform, 16)))
              : this.close(16, '');
          }
          getProgress() {
          ...
          onMove(e) {
            ...
            if (s <= 0)
              return (
                (this.progress = 0), (this.state = 1), this.appliedStyles ? void this.setCss(0, '', !1, '') : void 0
              );
            if (1 === this.state) {
              if (this.scrollEl.scrollTop > 0) return void (this.progress = 0);
              this.state = 2;
            }
            if ((r.cancelable && r.preventDefault(), this.setCss(s, '0ms', !0, ''), 0 === s))
              return void (this.progress = 0);
            const i = this.pullMin;
            (this.progress = s / i),
              this.didStart || ((this.didStart = !0), this.ionStart.emit()),
              this.ionPull.emit(),
              s < i ? (this.state = 2) : s > this.pullMax ? this.beginRefresh() : (this.state = 4);
          }
          onEnd() {
          ...
          close(e, r) {
            setTimeout(() => {
              ...
              (this.state = e),
              this.setCss(0, this.closeDuration, !0, r);
          }
          setCss(e, r, t, i) {
            this.nativeRefresher ||
              ...
              Object(s.f)(() => {
                if (this.scrollEl && this.backgroundContentEl) {
                  ...
                  (s.transform = n.transform = e > 0 ? `translateY(${e}px) translateZ(0px)` : ''),
                    (s.transitionDuration = n.transitionDuration = r),
      ...
      const y = class {
        ...
        componentWillLoad() {
          if (void 0 === this.pullingIcon) {
            ...
            this.pullingIcon = i.c.get(
              'refreshingIcon',
              'ios' === e && Object(i.a)('mobile') ? i.c.get('spinner', r) : 'circular'
            );
          }
          if (void 0 === this.refreshingSpinner) {
            const e = Object(i.b)(this);
            this.refreshingSpinner = i.c.get(
              'refreshingSpinner',
              i.c.get('spinner', 'ios' === e ? 'lines' : 'circular')
            );
          }
        }
        render() {
          const e = this.pullingIcon,
            r = null != e && void 0 !== f.a[e],
            t = Object(i.b)(this);
          return Object(s.j)(
            s.c,
            { class: t },
              ...
              this.pullingIcon &&
                ...
                Object(s.j)(
                  ...
                  Object(s.j)(
                    ...
                    Object(s.j)('ion-spinner', { name: this.pullingIcon, paused: !0 }),
                    'md' === t &&
                      'circular' === this.pullingIcon &&
                      Object(s.j)(
                        'div',
                        { class: 'arrow-container' },
                        Object(s.j)('ion-icon', { name: 'caret-back-sharp' })
                      )
                  )
                ),
              this.pullingIcon &&
                ...
                Object(s.j)(
                  'div',
                  { class: 'refresher-pulling-icon' },
                  Object(s.j)('ion-icon', { icon: this.pullingIcon, lazy: !1 })
                ),
              this.pullingText &&
                Object(s.j)('div', { class: 'refresher-pulling-text', innerHTML: Object(h.a)(this.pullingText) })
            ),
            Object(s.j)(
              'div',
              ...
              this.refreshingSpinner &&
                Object(s.j)(
                  ...
                  Object(s.j)('ion-spinner', { name: this.refreshingSpinner })
                ),
              this.refreshingText &&
                Object(s.j)('div', { class: 'refresher-refreshing-text', innerHTML: Object(h.a)(this.refreshingText) })
            )
          );
        }
        get el() {
