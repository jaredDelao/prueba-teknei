  ...
  [14],
  {
    hgI1: function (t, o, e) {
      ...
      const d = class {
          ...
          componentDidLoad() {
            g(async () => {
              const t = Object(n.a)(window, 'hybrid');
              n.c.getBoolean('_testing') ||
                e
                  .e(59)
                  .then(e.bind(null, 'cg4z'))
                  .then((t) => t.startTapClick(n.c)),
                n.c.getBoolean('statusTap', t) &&
                  e
                    .e(57)
                    .then(e.bind(null, 'PaPO'))
                    .then((t) => t.startStatusTap()),
                n.c.getBoolean('inputShims', b()) &&
                  e
                    .e(11)
                    .then(e.bind(null, '3Iwd'))
                    .then((t) => t.startInputShims(n.c));
              const o = await Promise.resolve().then(e.bind(null, 'B4Jq'));
              n.c.getBoolean('hardwareBackButton', t) ? o.startHardwareBackButton() : o.blockHardwareBackButton(),
                'undefined' != typeof window &&
                  e
                    .e(55)
                    .then(e.bind(null, 'nGaW'))
                    .then((t) => t.startKeyboardAssist(window)),
                e
                  .e(10)
                  .then(e.bind(null, 'Tsnu'))
          ...
          render() {
            ...
            return Object(i.j)(i.c, {
              class: { [t]: !0, 'ion-page': !0, 'force-statusbar-padding': n.c.getBoolean('_forceStatusbarPadding') },
            });
          }
          get el() {
        ...
        b = () => Object(n.a)(window, 'ios') && Object(n.a)(window, 'mobile'),
        g = (t) => {
      ...
      const p = class {
        ...
        render() {
          const t = Object(n.b)(this);
          return Object(i.j)(i.c, { class: { [t]: !0, 'buttons-collapse': this.collapse } });
        }
      };
      p.style = {
      ...
      const h = class {
          ...
          shouldForceOverscroll() {
            const { forceOverscroll: t } = this,
              o = Object(n.b)(this);
            return void 0 === t ? 'ios' === o && Object(n.a)('ios') : t;
          }
          resize() {
            this.fullscreen
              ? Object(i.h)(() => this.readDimensions())
              : (0 === this.cTop && 0 === this.cBottom) || ((this.cTop = this.cBottom = 0), Object(i.l)(this));
          }
          readDimensions() {
            const t = u(this.el),
              o = Math.max(this.el.offsetTop, 0),
              e = Math.max(t.offsetHeight - o - this.el.offsetHeight, 0);
            (o !== this.cTop || e !== this.cBottom) && ((this.cTop = o), (this.cBottom = e), Object(i.l)(this));
          }
          onScroll(t) {
            const o = Date.now(),
              e = !this.isScrolling;
          ...
          async scrollToPoint(t, o, e = 0) {
            ...
            if (e < 32) return null != o && (i.scrollTop = o), void (null != t && (i.scrollLeft = t));
            let n,
              r = 0;
            const a = new Promise((t) => (n = t)),
              s = i.scrollTop,
              l = i.scrollLeft,
              c = null != o ? o - s : 0,
              d = null != t ? t - l : 0,
              b = (t) => {
                const o = Math.min(1, (t - r) / e) - 1,
                  a = Math.pow(o, 3) + 1;
                0 !== c && (i.scrollTop = Math.floor(a * c + s)),
                  0 !== d && (i.scrollLeft = Math.floor(a * d + l)),
                  a < 1 ? requestAnimationFrame(b) : n();
              };
            return (
          ...
          render() {
            const { isMainContent: t, scrollX: o, scrollY: e } = this,
              ...
              l = t ? 'main' : 'div',
              c = 'ios' === a && n.c.getBoolean('experimentalTransitionShadow', !0);
            return (
              this.resize(),
              Object(i.j)(
                i.c,
                {
                  class: Object(r.a)(this.color, {
                    [a]: !0,
                    'content-sizing': Object(r.c)('ion-popover', this.el),
                    overscroll: s,
                  }),
                  style: { '--offset-top': this.cTop + 'px', '--offset-bottom': this.cBottom + 'px' },
                },
                Object(i.j)('div', { id: 'background-content', part: 'background' }),
                Object(i.j)(
                  l,
                  {
                    class: { 'inner-scroll': !0, 'scroll-x': o, 'scroll-y': e, overscroll: (o || e) && s },
        ...
        m = (t, o, e, i) => {
          const n = t.currentX,
            ...
            l = e - t.currentTime;
          if (
            (i && ((t.startTime = e), (t.startX = a), (t.startY = s), (t.velocityX = t.velocityY = 0)),
            (t.currentTime = e),
            ...
            const o = (s - r) / l;
            (t.velocityX = ((a - n) / l) * 0.7 + 0.3 * t.velocityX), (t.velocityY = 0.7 * o + 0.3 * t.velocityY);
          }
        };
      h.style =
      ...
      const f = class {
        ...
        render() {
          ...
          return Object(i.j)(
            ...
            {
              role: 'contentinfo',
              class: { [t]: !0, ['footer-' + t]: !0, 'footer-translucent': o, ['footer-translucent-' + t]: o },
            },
            'ios' === t && o && Object(i.j)('div', { class: 'footer-background' }),
            Object(i.j)('slot', null)
          );
        }
      };
      ...
      const v = (t) => {
        ...
        y = class {
          constructor(t) {
            Object(i.o)(this, t), (this.collapsibleHeaderInitialized = !1), (this.translucent = !1);
          }
          ...
          async checkCollapsibleHeader() {
            const t = 'condense' === this.collapse,
              o = !(!t || 'ios' !== Object(n.b)(this)) && t;
            if (!o && this.collapsibleHeaderInitialized) this.destroyCollapsibleHeader();
              ...
              Object(i.f)(() => {
                (v('ion-title').size = 'large'), v('ion-back-button');
              }),
          ...
          async setupCollapsibleHeader(t, o) {
            ...
            if (
              ((this.collapsibleMainHeader = Array.from(e).find((t) => 'condense' !== t.collapse)),
              !this.collapsibleMainHeader)
            )
              return;
                  ...
                  ((t, o, e, n) => {
                    Object(i.f)(() => {
                      ...
                      const r = t[0],
                        ...
                        c = Math.abs(a.left - r.boundingClientRect.left),
                      ...
                      Object(i.f)(() => {
                        ((t = [], o = 1, e = !1) => {
                          t.forEach((t) => {
                            ...
                            i &&
                              'large' === i.size &&
                              ((n.style.transition = e ? 'all 0.2s ease-in-out' : ''),
          ...
          render() {
            ...
            return Object(i.j)(
              ...
              'ios' === o && t && Object(i.j)('div', { class: 'header-background' }),
              Object(i.j)('slot', null)
            );
          }
          get el() {
      ...
      const A = class {
        ...
        async connectedCallback() {
          ...
          (this.gesture = (await e.e(2).then(e.bind(null, 'Pu4v'))).createSwipeBackGesture(
            this.el,
            ...
            (t, o, e) => {
              if (this.ani) {
                ...
                let i = t ? -0.001 : 0.001;
                t
                  ? (i += Object(s.a)([0, 0], [0.32, 0.72], [0, 1], [1, 1], o)[0])
                  : (this.ani.easing('cubic-bezier(1, 0, 0.68, 0.28)'),
                    (i += Object(s.a)([0, 0], [1, 0], [0.68, 0.28], [1, 1], o)[0])),
        ...
        async setRoot(t, o, e) {
          ...
          const i = this.activeEl,
            n = await Object(l.a)(this.delegate, this.el, t, ['ion-page', 'ion-page-invisible'], o);
          return (
        ...
        async transition(t, o, e = {}) {
          ...
          const { el: i, mode: r } = this,
            a = this.animated && n.c.getBoolean('animated', !0),
            s = e.animationBuilder || this.animation || n.c.get('navAnimation');
          return (
            await Object(c.j)(
              Object.assign(
                Object.assign(
                  {
                    ...
                    progressCallback: e.progressAnimation
                      ? (t) => {
                          void 0 === t || this.gestureOrAnimationInProgress
                            ? (this.ani = t)
      ...
      const j = class {
        constructor(t) {
          Object(i.o)(this, t), (this.ionStyle = Object(i.g)(this, 'ionStyle', 7));
        }
        sizeChanged() {
          this.emitStyle();
        }
        ...
        render() {
          ...
          return Object(i.j)(
            i.c,
            { class: Object(r.a)(this.color, { [t]: !0, ['title-' + o]: !0, 'title-rtl': 'rtl' === document.dir }) },
            Object(i.j)('div', { class: 'toolbar-title' }, Object(i.j)('slot', null))
          );
        }
        get el() {
          return Object(i.k)(this);
          ...
          return (
            ...
            Object(i.j)(
              ...
              Object(i.j)(
                ...
                Object(i.j)('div', { class: 'toolbar-content' }, Object(i.j)('slot', null)),
