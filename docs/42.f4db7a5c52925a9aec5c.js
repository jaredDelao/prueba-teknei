      ...
      const s = class {
        constructor(a) {
          Object(o.o)(this, a),
            ...
            (this.cancelButtonIcon = i.c.get('backButtonIcon', 'arrow-back-sharp')),
            ...
            (this.type = 'search'),
            (this.value = ''),
            (this.onClearInput = (a, r) => {
              this.ionClear.emit(),
                a && (a.preventDefault(), a.stopPropagation()),
                setTimeout(() => {
                  '' !== this.getValue() &&
                    ((this.value = ''), this.ionInput.emit(), r && !this.focused && this.setFocus());
                }, 64);
            }),
        ...
        debounceChanged() {
          this.ionChange = Object(t.f)(this.ionChange, this.debounce);
        }
        valueChanged() {
          const a = this.nativeInput,
            r = this.getValue();
          a && a.value !== r && (a.value = r), this.ionChange.emit({ value: r });
        }
        showCancelButtonChanged() {
          requestAnimationFrame(() => {
            this.positionElements(), Object(o.l)(this);
          });
        }
        connectedCallback() {
          this.emitStyle();
        ...
        positionElements() {
          ...
          (this.shouldAlignLeft = o),
            'ios' === e && (r !== o && this.positionPlaceholder(), this.animated && this.positionCancelButton());
        }
        positionPlaceholder() {
          const a = this.nativeInput;
          if (!a) return;
          const r = 'rtl' === document.dir,
            e = (this.el.shadowRoot || this.el).querySelector('.searchbar-search-icon');
          if (this.shouldAlignLeft) a.removeAttribute('style'), e.removeAttribute('style');
          else {
            const o = document,
            ...
            (i.innerText = this.placeholder || ''),
              ...
              Object(t.q)(() => {
                ...
                i.remove();
                const t = 'calc(50% - ' + o / 2 + 'px)',
                  n = 'calc(50% - ' + (o / 2 + 30) + 'px)';
                r
                  ? ((a.style.paddingRight = t), (e.style.marginRight = n))
                  : ((a.style.paddingLeft = t), (e.style.marginLeft = n));
              });
          }
        }
        positionCancelButton() {
          ...
          if (r && e !== this.isCancelVisible) {
            const o = r.style;
            if (((this.isCancelVisible = e), e)) a ? (o.marginLeft = '0') : (o.marginRight = '0');
            else {
              const e = r.offsetWidth;
              e > 0 && (a ? (o.marginLeft = -e + 'px') : (o.marginRight = -e + 'px'));
            }
          }
        }
        getValue() {
        ...
        render() {
          const { cancelButtonText: a } = this,
            r = this.animated && i.c.getBoolean('animated', !0),
            e = Object(i.b)(this),
            t = this.clearIcon || ('ios' === e ? 'close-circle' : 'close-sharp'),
            s = this.searchIcon || ('ios' === e ? 'search-outline' : 'search-sharp'),
            c = this.shouldShowCancelButton(),
            h =
              ...
              Object(o.j)(
                ...
                Object(o.j)(
                  ...
                  { 'aria-hidden': 'true' },
                  'md' === e
                    ? Object(o.j)('ion-icon', { 'aria-hidden': 'true', mode: e, icon: this.cancelButtonIcon, lazy: !1 })
                    : a
                )
              );
          return Object(o.j)(
            ...
            Object(o.j)(
              ...
              Object(o.j)(
                'button',
                {
                  ...
                  onMouseDown: (a) => this.onClearInput(a, !0),
                  onTouchStart: (a) => this.onClearInput(a, !0),
                },
                Object(o.j)('ion-icon', {
                  'aria-hidden': 'true',
                  mode: e,
